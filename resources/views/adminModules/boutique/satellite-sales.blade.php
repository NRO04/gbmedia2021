...
@section('pageTitle', 'Histórico de Ventas Satélites')
        ...
        <div class="card col-lg-12">
            <div class="card-header row">
                <div class="col-xs-12 col-sm-6 mb-2">
                    <span class="span-title">Histórico de Ventas Satélite | <span class="text-info"><span id="title-week">{{ $selected_week }}</span></span></span>
                </div>
                <div class="col-xs-12 col-sm-6 text-sm-right" id="container-export">
                    @can('boutique-export-satellite-sales')
                        <a class="btn btn-outline-success btn-sm" id="export-week-sales" href="{{ route('boutique.export_satellite_week_sales', [$selected_week_start, $selected_week_end]) }}">
...
@endsection @push('scripts')
    <script>
                    ...
                    methods: {
                        getData: function () {
                            table = $("#sales-table").DataTable({
                                ...
                                ajax: {
                                    url: '{{ route('boutique.get_satellite_sales') }}',
                                    dataSrc: "data",
                                    type: "GET",
                                    data: function(data) {
        ...
        $('#select-week').on('change', function () {
            ...
            let url = '{{ route("boutique.export_satellite_week_sales", [":start", ":end"]) }}';
        ...
        {
            SwalGB.fire({
                title: '¿Está seguro que desea eliminar la venta seleccionado?',
                icon: 'question',
