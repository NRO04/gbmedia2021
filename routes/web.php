...
|
| All the routes must be commnet and the comment of the routes must be without indentation, the code must start in the
| first identation
*/
...
Route::group(['prefix' => 'scripts', 'as' => 'script.'], function () {
    Route::get('/satellite/execute', "Satellite\SatelliteController@executeScript")->name('satellite.execute');
    Route::get('/users/execute', "Users\UserController@executeScript")->name('user.execute');
    Route::get('/users/documents/execute', "Users\UserController@userDocumentsExecute")->name('user.documents.execute');
    Route::get('/news/execute', "News\NewsController@execute")->name('news.execute');
    Route::get('/wiki/execute', "Wiki\WikiController@execute")->name('wiki.execute');
    Route::get('/training/execute', "Training\TrainingController@execute")->name('training.execute');
    Route::get('/tasks/execute', "Tasks\TaskController@execute")->name('tasks.execute');
    Route::get('/tasks/comments/execute', "Tasks\TaskController@executeTasksComments")->name('tasks.comments.execute');
    Route::get('/tasks/status/execute', "Tasks\TaskController@tasksStatusExecute")->name('tasks.status.execute');
    Route::get('/tasks/files/execute', "Tasks\TaskController@executeTasksFiles")->name('tasks.execute_tasks_files');
    Route::get('/tasks/users/execute', "Tasks\TaskController@executeTasksUsers")->name('tasks.execute_tasks_users');
    Route::get('/alarms/execute', "Alarms\AlarmController@execute")->name('alarms.execute');
    Route::get('/bookings/execute', "Booking\BookingController@execute")->name('bookings.execute');
    Route::get('/prospects/execute', "HumanResources\HumanResourceController@execute")->name('prospects.execute');
    Route::get('/monitoring/execute', "Monitoring\MonitoringController@execute")->name('monitoring.execute');
    Route::get('/hours/execute', "HumanResources\HumanResourceController@extraHoursExecute")->name('hours.execute');
    Route::get('/vacations/execute', "HumanResources\HumanResourceController@vacationsExecute")->name('vacations.execute');
    Route::get('/vacations/users/execute', "HumanResources\HumanResourceController@usersVacationsExecute")->name('vacations.users.execute');
    Route::get('/schedules/execute', "Schedule\ScheduleController@execute")->name('schedules.execute');
    Route::get('/payrolls/users/execute', "Payrolls\PayrollController@usersPayrollsExecute")->name('payroll.users.execute');
    Route::get('/payrolls/movements/execute', "Payrolls\PayrollController@usersPayrollMovementsExecute")->name('payroll.movements.execute');
    Route::get('/products/execute', "Boutique\BoutiqueController@productsExecute")->name('products.execute');
    Route::get('/sales/execute', "Boutique\BoutiqueController@salesExecute")->name('sales.execute');
    Route::get('/satellite/sales/execute', "Boutique\BoutiqueController@satelliteSalesExecute")->name('satellite.sales.execute');
    Route::get('/blocked-users/execute', "Boutique\BoutiqueController@blockedUsersExecute")->name('blocked_users.execute');
    Route::get('/inventories/execute', "Boutique\BoutiqueController@inventoriesExecute")->name('inventories.execute');
    Route::get('/products-logs/execute', "Boutique\BoutiqueController@productsLogsExecute")->name('products_logs.execute');
    Route::get('/monitoring/updateSatelliteUser', "Monitoring\MonitoringController@updateSatelliteUser")->name('monitoring.updateSatelliteUser');
    Route::get('/loans/execute', "Loans\LoanController@scriptLoans")->name('loans.execute');
    Route::get('/statistics/execute', "Statistics\StatisticsController@execute")->name('statistics.execute');
    Route::get('/statistics/pageurl', "Statistics\StatisticsController@pageurl")->name('statistics.pegeurl');
    Route::get('/statistics/goals', "Statistics\StatisticsController@goals")->name('statistics.goals');
    Route::get('/templates/execute', "Satellite\SatelliteController@pageTemplatesExecute")->name('page.templates.execute');
    Route::get('/pending-emails/execute', "Satellite\SatelliteController@sendPendingEmailsExecute")->name('pending.emails.execute');
    Route::get('/satellite/scriptSatelliteLogs', "Satellite\SatelliteController@scriptSatelliteLogs")->name('scriptSatelliteLogs');
    Route::get('/referred/execute', "HumanResources\HumanResourceController@referredProspectsExecute")->name('referred.execute');
    Route::get('/referred/seen/execute', "HumanResources\HumanResourceController@referredSeenProspectsExecute")->name('referred.execute');
    Route::get('/referred/studios/execute', "HumanResources\HumanResourceController@referredToStudiosExecute")->name('referred.execute');
    Route::get('/referred/shared/execute', "HumanResources\HumanResourceController@referredSharedToStudiosExecute")->name('referred.execute');
    Route::get('/cites/execute', "HumanResources\HumanResourceController@creteInterviewsCiteTasksExecute");
    Route::get('/apis/scriptApiChaturbate', "Satellite\SatelliteController@scriptApiChaturbate");
    Route::get('/satellite/scriptSetModelInactive', "Satellite\SatelliteController@scriptSetModelInactive");
    Route::get('/monitoring/executeAddLocation', "Monitoring\MonitoringController@executeAddLocation");
});
...
Route::group(['prefix' => 'home', 'as' => 'home.', 'middleware' => ['auth']], function () {
    ...
    Route::post('/getAttendanceStats', 'HomeController@getAttendanceStats')->name('getAttendanceStats');
    Route::get('/homeLocations', 'HomeController@getLocations')->name('getLocations');
});
...
Route::group(['prefix' => 'contracts', 'as' => 'contracts.', 'middleware' => ['auth']], function () {
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::get('/edit-info', 'Contracts\ContractController@editingInfo')->name('edit_info');
...
Route::group(['prefix' => 'news', 'as' => 'news.', 'middleware' => ['auth']], function () {
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::get('/studios',      'News\NewsController@getStudios')->name('getStudios');
        Route::post('/share',               'News\NewsController@share')->name('share');
    });
});
...
Route::get('testPayroll/{id}', 'Payrolls\PayrollController@caculatedSocialSecurity');
