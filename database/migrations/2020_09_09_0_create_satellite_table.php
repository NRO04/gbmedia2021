...
class CreateSatelliteTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('satellite_payment_payroll', function (Blueprint $table) {
            ...
            $table->string('original_total', 150)->nullable();
        ...
        Schema::create('satellite_prospects_historial', function (Blueprint $table) {
            $table->id();
            $table->foreignId('prospect_id')->nullable()->references('id')->on('satellite_prospects');
        ...
        Schema::create('satellite_apis', function (Blueprint $table) {
            $table->id();
            $table->string('user');
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('satellite_apis');
    }
}
