...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            $table->id()->onDelete('NO ACTION')->onUpdate('NO ACTION');
            //foreign keys
            $table->foreignId('setting_location_id')->nullable()->constrained()->onDelete('NO ACTION')->onUpdate('NO ACTION');
            $table->foreignId('setting_role_id')->references('id')->on('setting_roles')->onDelete('NO ACTION')->onUpdate('NO ACTION');
            $table->foreignId('blood_type_id')->references('id')->on('global_blood_types')->onDelete('NO ACTION')->onUpdate('NO ACTION');
            $table->foreignId('department_id')->references('id')->on('global_departments')->onDelete('NO ACTION')->onUpdate('NO ACTION');
            $table->foreignId('city_id')->references('id')->on('global_cities')->onDelete('NO ACTION')->onUpdate('NO ACTION');
            $table->foreignId('document_id')->references('id')->on('global_documents')->onDelete('NO ACTION')->onUpdate('NO ACTION');
            $table->foreignId('contract_id')->default(1)->references('id')->on('global_type_contracts')->onDelete('NO ACTION')->onUpdate('NO ACTION');
            $table->foreignId('eps_id')->default(1)->references('id')->on('global_eps')->onDelete('NO ACTION')->onUpdate('NO ACTION');
            ...
            $table->foreignId('bank_account_id')->default(1)->references('id')->on('global_banks')->onDelete('NO ACTION')->onUpdate('NO ACTION');
            $table->foreignId('bank_account_document_id')->references('id')->on('global_documents')->onDelete('NO ACTION')->onUpdate('NO ACTION');
