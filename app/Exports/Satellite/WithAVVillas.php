...
use App\Exports\Satellite\BancoomevaOthersSheet;
use Maatwebsite\Excel\Concerns\Exportable;
use Maatwebsite\Excel\Concerns\WithMultipleSheets;

class WithAVVillas implements WithMultipleSheets
{
    ...
    public function sheets(): array
    {
        ...
        $sheets[] = new AVVillasOthersSheet($this->payrolls["avvillas"]);
        $sheets[] = new BancolombiaOthersSheet($this->payrolls["bancolombia_others"]);
        $sheets[] = new BancoomevaOthersSheet($this->payrolls["bancoomeva_others"]);
